...
import { getYearlySummary, getMonthlySummary, getCategories } from "@/lib/db"
...
export default function Analytics() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true)
    try {
      const [yearData, catData, monthData] = await Promise.all([
      ...
      setMonthlyBreakdown(monthData.category_breakdown)
    } catch (error) {
